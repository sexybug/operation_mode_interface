...
static int aes_set_encrypt_key(AES_KEY *aes_key, const uint8_t *key, size_t keylen)
{
...
static int aes_set_decrypt_key(AES_KEY *aes_key, const uint8_t *key, size_t keylen)
{
	int ret = 0;
	AES_KEY enc_key;
	size_t i;
...
static void aes_encrypt(const AES_KEY *key, const uint8_t in[16], uint8_t out[16])
{
	uint8_t state[4][4];
	size_t i;
...
static void aes_decrypt(const AES_KEY *aes_key, const uint8_t in[16], uint8_t out[16])
{
	uint8_t state[4][4];
	size_t i;
